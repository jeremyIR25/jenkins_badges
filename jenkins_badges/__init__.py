...
def create_app(from_envvar=False, base_url=None, username=None, token=None,
               ...
               coverage_decimal_points=2, tests_yellow_threshold=0.99, tests_red_threshold=0.9, tests_filename="result.json"):
    '''
    ...
    app.config['TESTS_RESULTS_YELLOW_THRESHOLD'] = tests_yellow_threshold
    app.config['TESTS_RESULTS_RED_THRESHOLD'] = tests_red_threshold
    app.config['TESTS_RESULTS_FILE_NAME'] = tests_filename
